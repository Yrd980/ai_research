...
- #1 Qwen 3.5系列模型即将发布
- #2 xAI上线Grok Imagine Image Pro 模型 API
- #3 CodeBuddy团队发布AI桌面工作台WorkBuddy
- #4 字节即将推出Seedream 5.0预览版
- #5 Meta AI 已在官网测试最新模型 Avocado

## #1 Qwen 3.5系列模型即将发布（原文）
...
## #2 xAI上线Grok Imagine Image Pro 模型 API（原文）
...
## #3 CodeBuddy团队发布AI桌面工作台WorkBuddy（原文）
...
## #5 Meta AI 已在官网测试最新模型 Avocado（原文）
...
---
提示：内容由AI辅助创作，可能存在幻觉和错误。作者橘鸦Juya，视频版在同名哔哩哔哩。
